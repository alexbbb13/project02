...
module.exports.getUserIdFilename = function(photoId){
	return new Promise(function(resolve, reject) {

		const query = 'SELECT user_id,filename FROM photo_users LEFT JOIN photos on photos.id=photo_users.photo_id WHERE photo_users.photo_id = $1::int';
